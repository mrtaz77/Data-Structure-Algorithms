...
public:
    ...
    BinNode<E>* unionNode(BinNode<E>* node) {
        ...
        BinNode<E>* newChild = new BinNode<E>();
        BinNode<E>* newParent = new BinNode<E>();
        ...
        if(newParent->child() != NULL)newChild = newChild->setSibling(newParent->child());
        newChild = newChild->setParent(newParent);
        newParent = newParent->setChild(newChild);
        newParent->deg += 1;
